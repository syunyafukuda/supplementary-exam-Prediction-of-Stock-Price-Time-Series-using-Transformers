...
train = ITUB4_df['2008-04-01':'2008-04-23']
validation = ITUB4_df['2008-04-24':]
...
# ITUB4_dfのデータを標準化します
ITUB4_scaled = scaler.fit_transform(ITUB4_df)

# 標準化したデータを再びデータフレームに変換します
ITUB4_scaled_df = pd.DataFrame(ITUB4_scaled, columns=ITUB4_df.columns, index=ITUB4_df.index)

# 指定された日付でデータを訓練データと検証データに分割します
train_data = ITUB4_scaled_df['2008-04-01':'2008-04-23']
validation_data = ITUB4_scaled_df['2008-04-24':]
...
# 指定された日付でデータを訓練データと検証データに分割します
train = ITUB4_scaled_df['2008-04-01':'2008-04-23']
validation = ITUB4_scaled_df['2008-04-24':]
...
# プロットのタイトルと軸ラベルを設定します
fig.update_layout(title='ITUB4 Predicts vs Actual',
                  xaxis_title='Date',
                  yaxis_title='Value')
