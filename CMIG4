...
train = CMIG4_df['2008-04-01':'2008-04-23']
validation = CMIG4_df['2008-04-24':]
...
# CMIG4_dfのデータを標準化します
CMIG4_scaled = scaler.fit_transform(CMIG4_df)

# 標準化したデータを再びデータフレームに変換します
CMIG4_scaled_df = pd.DataFrame(CMIG4_scaled, columns=CMIG4_df.columns, index=CMIG4_df.index)

# 指定された日付でデータを訓練データと検証データに分割します
train_data = CMIG4_scaled_df['2008-04-01':'2008-04-23']
validation_data = CMIG4_scaled_df['2008-04-24':]
...
# 指定された日付でデータを訓練データと検証データに分割します
train = CMIG4_scaled_df['2008-04-01':'2008-04-23']
validation = CMIG4_scaled_df['2008-04-24':]
...
# プロットのタイトルと軸ラベルを設定します
fig.update_layout(title='CMIG4 Predicts vs Actual',
                  xaxis_title='Date',
                  yaxis_title='Value')
