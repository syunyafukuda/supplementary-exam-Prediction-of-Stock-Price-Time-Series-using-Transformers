...
train = BRAP4_df['2008-04-01':'2008-04-23']
validation = BRAP4_df['2008-04-24':]
...
# BRAP4_dfのデータを標準化します
BRAP4_scaled = scaler.fit_transform(BRAP4_df)

# 標準化したデータを再びデータフレームに変換します
BRAP4_scaled_df = pd.DataFrame(BRAP4_scaled, columns=BRAP4_df.columns, index=BRAP4_df.index)

# 指定された日付でデータを訓練データと検証データに分割します
train_data = BRAP4_scaled_df['2008-04-01':'2008-04-23']
validation_data = BRAP4_scaled_df['2008-04-24':]
...
# 指定された日付でデータを訓練データと検証データに分割します
train = BRAP4_scaled_df['2008-04-01':'2008-04-23']
validation = BRAP4_scaled_df['2008-04-24':]
...
# プロットのタイトルと軸ラベルを設定します
fig.update_layout(title='BRAP4 Predicts vs Actual',
                  xaxis_title='Date',
                  yaxis_title='Value')
